...
/// @author chenyun
class MultiProviderNestingExample extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    DataInfo dataInfo = DataInfo(0);
    return ValueListenableProvider<int>(
      builder: (_) => dataInfo,
      child: ChangeNotifierProvider<WeatherInfo>(
        builder: (_) => WeatherInfo(),
        child: Scaffold(
          appBar: AppBar(
            title: Text("MultiProviderNestingExample"),
          ),
          body: Center(
            child: Column(
              ...
              return FloatingActionButton(
                ...
                onPressed: () {
                  String newWeatherType =
                      "celcius" == weatherInfo.temperatureType
                          ? "far"
                          : "celcius";
